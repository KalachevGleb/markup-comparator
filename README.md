...
Эта метрика выравнивает вклад кодов, которые встречаются разное количество раз. Здесь количество вхождений одного
Например, 1 пропущенное вхождение из 5 будет оценено как 0.2.

**Интерпретация**: Дает наиболее сбалансированную оценку качества разметки, поскольку учитывает разную частоту встречаемости кодов.
